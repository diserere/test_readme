...
`ton-dev-cli` package installs its main executable `tondev` globally and it accessible through system path,  
so you could use it everywhere in your file system just typing `tondev`.
